        ...
        seq(fileNames)
            ...
            .seq(function (texts) {
                cb(null, {
                    ...
                    fixedUpExtJS: true,
                    text: texts.join("\n"),
                    noOriginalRelations: true, // Save transforms.populate the trouble of parsing it to find zero relations
    ...
    function resolvePkg(pkg, cb) {
        ...
        seq(pkg.packages || [])
            ...
            .parMap(function (url) {
                ...
                if (/\.js$/.test(url)) {
                    assetConfig.noOriginalRelations = true; // Save transforms.populate the trouble of parsing it to find zero relations
                }
