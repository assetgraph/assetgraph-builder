    ...
    return function buildProduction(assetGraph, cb) {
        ...
        assetGraph
            ...
            .if(options.manifest)
                ...
                .endif()
            .endif()
            .moveAssetsInOrder({isLoaded: true, isInline: false, type: query.not('CacheManifest'), fileName: query.not(['.htaccess', 'humans.txt', 'robots.txt', 'favicon.ico'])}, function (asset, assetGraph) {
