...
module.exports = function (options) {
    ...
    return async function buildProduction(assetGraph) {
        ...
        if (minify) {
            await assetGraph.minifyAssets({isLoaded: true, isInline: false});
        }
        ...
        if (minify) {
            await assetGraph.minifyAssets({isLoaded: true});
        }
        ...
        if (options.pretty) {
            await assetGraph.prettyPrintAssets({type: 'Css', isLoaded: true});
            await assetGraph.prettyPrintAssets(function (asset) {
