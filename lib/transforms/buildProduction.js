...
module.exports = function (options) {
    ...
    return function buildProduction(assetGraph, cb) {
        ...
        var moveAssetsInOrderQuery = query.and(
            {
                isLoaded: true,
                isInline: false,
        ...
        assetGraph
            ...
            .if(options.precacheServiceWorker)
                ...
                .queue(function omitFunctionCalls(assetGraph) {
                    assetGraph.findRelations({type: 'JavaScriptStaticUrl', from: { fileName: /precache-service-worker\.js$/ }, to: {isLoaded: true}}).forEach(function (relation) {
                        relation.omitFunctionCall();
                    });
                })
                .if(minify)
                    .minifyAssets({isLoaded: true, isInline: false, fileName: /precache-service-worker\.js$/})
                .endif()
                .if(!options.noCompress)
                    .compressJavaScript({type: 'JavaScript', isLoaded: true, fileName: /precache-service-worker\.js$/}, 'uglifyJs')
                .endif()
            .endif()
