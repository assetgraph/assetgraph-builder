...
module.exports = function (options) {
    ...
    if (options.browsers) {
        var autoprefixer = loadAndInstantiateAutoprefixer(options.browsers, 'The \'browsers\' option requires the autoprefixer module to be available. Please install it in the containing project.');
