...
function getParsedDataSystemJsConditionalsFromHtmlElement(node) {
    var dataCond = node.getAttribute('data-systemjs-conditions');
    if (dataCond) {
                ...
                if (conditionValues.length > 0) {
                    conditionValues.forEach(function (conditionValue) {
                        ...
                        if (documentElement) {
                            ...
                            htmlSystemJsConditionals[condition] = conditionValue;
                            documentElement.setAttribute('data-systemjs-conditions', Object.keys(htmlSystemJsConditionals).map(function (key) {
