                            ...
                            name: function (name) {
                                if (Object.prototype.hasOwnProperty.call(globalValueByName, name)) {
                                    var stack = walker.stack(),
                                        ...
                                        stackIndex = stack.length - 2;

                                    // Make sure that we're not in the LHS of an ['assign', ...] node:

                                    while (stackIndex >= 0 && stack[stackIndex][0] === 'dot') {
                                        stackIndex -= 1;
                                    }

                                    if (stack[stackIndex][0] !== 'assign' || stack[stackIndex][2] !== stack[stackIndex + 1]) {
