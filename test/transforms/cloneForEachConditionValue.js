    ...
    return new AssetGraph({
      ...
      .queue(function(assetGraph) {
        ...
        expect(
          ...
          .and(
            'to contain',
            '<html data-assetgraph-conditions="weather: \'sunny\'">'
          )
        ...
        expect(
          ...
          .and(
            'to contain',
            '<html data-assetgraph-conditions="weather: \'rainy\'">'
          )
    ...
    return new AssetGraph({
      ...
      .queue(function(assetGraph) {
        ...
        expect(
          ...
          { from: { fileName: 'index.sunny.happy.html' } },
          4
        );
        expect(
          assetGraph,
          'to contain relations',
          { from: { fileName: 'index.sunny.sad.html' } },
          4
        );
        expect(
          assetGraph,
          'to contain relations',
          { from: { fileName: 'index.rainy.happy.html' } },
          4
        );
        expect(
          assetGraph,
          'to contain relations',
          { from: { fileName: 'index.rainy.sad.html' } },
          4
        );

        expect(
          assetGraph.findAssets({ fileName: 'index.sunny.happy.html' })[0].text,
          'to contain',
          'sunny'
        )
          .and('not to contain', 'rainy')
          .and('to contain', 'happy')
          .and('not to contain', 'sad')
          .and(
            'to contain',
            "<html data-assetgraph-conditions=\"weather: 'sunny', mood: 'happy'\">"
          );
        expect(
          assetGraph.findAssets({ fileName: 'index.sunny.sad.html' })[0].text,
          'to contain',
          'sunny'
        )
          .and('not to contain', 'rainy')
          .and('not to contain', 'happy')
          .and('to contain', 'sad');
        expect(
          assetGraph.findAssets({ fileName: 'index.rainy.happy.html' })[0].text,
          'not to contain',
          'sunny'
        )
          .and('to contain', 'rainy')
          .and('to contain', 'happy')
          .and('not to contain', 'sad');
        expect(
          assetGraph.findAssets({ fileName: 'index.rainy.sad.html' })[0].text,
          'not to contain',
          'sunny'
        )
          .and('to contain', 'rainy')
